...
const MyMap = () => {
	...
	const load = () => {
		...
		for (let feature of mapData.features) {
			...
			const specificBuilding = data.find((item) => feature.properties.name === item.departemnt);
	...
	return (
		<div>
			...
			{buildings.length === 0 ? (
				...
				<Map style={{ height: "80vh", backgroundColor: "yellow" }} zoom={2} center={[2.5, 10.5]}>
					<GeoJSON style={buildingStyle} data={mapData.features} onEachFeature={onEachFeature} />
